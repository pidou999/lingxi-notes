...
# 跳过 Playwright（节省约 300MB）
PLAYWRIGHT=no curl -fsSL https://raw.githubusercontent.com/pidou999/lingxi-notes/main/scripts/bootstrap.sh | bash
```

```powershell
# Windows（PowerShell 7+）
irm https://raw.githubusercontent.com/pidou999/lingxi-notes/main/scripts/bootstrap.ps1 | iex

# 跳过 Playwright
irm https://raw.githubusercontent.com/pidou999/lingxi-notes/main/scripts/bootstrap.ps1 | iex -Args "-SkipPlaywright"
```
...
浏览器打开 http://localhost:8877 即可使用。即可使用。
